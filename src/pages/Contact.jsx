...
const Contact = () => {
  return (
    ...
    <section className='relative px-4 md:px-16 lg:px-32 z-30 py-20 lg:py-32'>
        <div className='relative w-full flex justify-center items-center mb-10 text-white bg-[url("/src/assets/helpdesk.webp")] bg-cover bg-center bg-no-repeat h-[150px] md:h-[300px]'>
            <div className='absolute w-full h-full bg-black/50 z-0'></div>
            <h1 className='relative text-5xl font-semibold z-20'>Contact Us</h1>
        </div>

        <div className='relative w-full flex flex-col lg:grid lg:grid-cols-10 gap-10 px-5 md:px-10 lg:px-0 py-5 lg:py-10'>
            <motion.form 
                ...
                <div className='w-full flex flex-col gap-2'>
                    <h2 className='text-xl md:text-2xl font-semibold'>Have a question?</h2>
                    <p className='text-xs md:text-sm text-gray-500 w-[70%]'>We are here to help you. Please fill out the form below and we will get back to you as soon as possible.</p>
                </div>
                <div className='col-span-10 md:col-span-6 flex flex-col gap-8'>
                    <div className='w-full flex flex-col gap-2'>
                        <label htmlFor="name" className='text-xs md:text-sm font-semibold'>Name</label>
                    ...
                    <div className='w-full flex flex-col gap-2'>
                        <label htmlFor="email" className='text-xs md:text-sm font-semibold'>Email</label>
                    ...
                    <div className='w-full flex flex-col gap-2'>
                        <label htmlFor="message" className='text-xs md:text-sm font-semibold'>Message</label>
            ...
            <motion.div
                ...
                transition={{ duration: 0.2, ease: "easeInOut" }}
                viewport={{ amount: 0.2 }}
                className='w-full h-fit col-span-4 flex flex-col gap-10 text-sm p-6 rounded-3xl bg-secondary-50 border-[1px] border-secondary-400 border-dashed lg:sticky top-5'
            >
