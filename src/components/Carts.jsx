...
const Cart = ({products, cart, addItem, items, subtotal, show, minus, itemNum, sum, handleShow}) => {
  if(items.length < 1) {
    return (
        <div className={show === false ?  'hidden' : 'w-full h-full fixed bg-white z-50 duration-300'}>
