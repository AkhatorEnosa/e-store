  ...
  return (
    <div className="w-full h-fit lg:h-screen flex flex-col lg:grid grid-cols-7 py-20 mt-6 lg:mt-16 px-8 md:px-16 lg:px-32 md:gap-8 lg:gap-10 justify-around md:justify-evenly items-center bg-[#f6f6f6]">
      <motion.div
       ...
       className="col-span-full lg:col-span-3 lg:py-6 flex flex-col gap-4 justify-center lg:justify-evenly lg:h-[550px] z-40 order-last lg:order-first lg:text-left text-justify">
        ...
        <div className="flex flex-col gap-2 mt-10 lg:mt-0">
          ...
          >
            <h1 className="text-3xl md:text-5xl lg:text-8xl font-black tracking-tighter">
              {title}
            </h1>
          </Navigator>
